  ...
  render() {
    ...
    return (
      <S.Filters style={style}>
        {!hideView && (
          <S.Select
            defaultValue={Filter.View.ALL}
            onChange={(evt) =>
              this.props.onChange(Filter.Kind.VIEW, evt.target.value)
            }
          >
            {viewOptions.map((o, i) => (
        ...
        {!hideCurrency && (
          <S.Select
            ...
            onChange={(evt) =>
              this.props.onChange(Filter.Kind.CURRENCY, evt.target.value)
            }
          >
        ...
        {!hidePerPage && (
          <S.Select
            defaultValue={Filter.DEFAULT_PAGING_SIZE}
            onChange={(evt) =>
              this.props.onChange(Filter.Kind.PER_PAGE, evt.target.value)
            }
          >
